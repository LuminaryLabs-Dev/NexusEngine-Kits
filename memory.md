...
Most baseline entries remain placeholders or scaffolds. `generic-resource-loop-kit` is the first official baseline behavior, promoted from ProtoKits commit `9da1fdb979a878dff8f50565fec4a4952e58af5e`; `completion-ledger-kit` remains a candidate. `protokit-core` is resolved as a deprecated compatibility bridge from ProtoKits commit `9b0d74c57c29d04a9ba955ae41c8ca19cb2cd5d6`; NexusEngine remains the canonical owner of its core utility behavior. The registry, capability graph, and composition planner are three official approved additions promoted from ProtoKits commit `e4e8a1e03943d1fb7ab1bfddb8837ad16b919c29`. Current generated progress is 2 / 120 baseline resolved, 118 remaining, 3 / 3 additions resolved, 4 official kits, and 1 deprecated kit. Default installer, domain, bundle, and all-kit paths execute only real allowed-status factories and never synthesize empty placeholder runtimes.
