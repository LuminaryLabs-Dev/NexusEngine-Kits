...
- Browser, AR, and device integrations require host-provided APIs and still
  need product-level browser proof.
- Defaults are generic examples, not complete products.
